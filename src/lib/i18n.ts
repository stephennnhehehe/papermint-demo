...
export const dictionaries: Record<Language, Record<TranslationKey, string>> = {
  ...
  zh: {
    ...
    dashboard: "看板", documents: "单据", customers: "客户", expenses: "费用", inventory: "库存", settings: "设置", pricing: "定价",
  ...
  vi: {
    ...
    dashboard: "Tổng quan", documents: "Chứng từ", customers: "Khách hàng", expenses: "Chi phí", inventory: "Kho", settings: "Cài đặt", pricing: "Bảng giá",
  ...
  ar: {
    ...
    dashboard: "لوحة التحكم", documents: "المستندات", customers: "العملاء", expenses: "المصروفات", inventory: "المخزون", settings: "الإعدادات", pricing: "الأسعار",
